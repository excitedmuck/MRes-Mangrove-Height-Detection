...
#        tiff_file <- "S2_2020_resampled_25_image.tif
# Output:  "Models, summarymetrics_predictions_2020_cropped.rds"

shapefile_dir <- "/Users/yayayapoop/Library/CloudStorage/OneDrive-TheUniversityofNottingham/Mres - Onedrive/15 04 23 - Sujit Earth engine shape file- WD/Working Folder/23 06 23 - Working Folder - WD.1/21 08 23 - Bulk download L2A 2020/cropped"
tiff_file <- "S2_2020_resampled_25_image.tif"
...
library(gridExtra)
saveRDS(results_all, "Models, summarymetrics_predictions_2020_cropped.rds")
